...
public class InternalJSONLexer extends Lexer {
    ...
    public final void mRULE_JSONNUMBER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalJSON.g:1191:17: ( ( '-' )? ( '0' | '1' .. '9' ( RULE_DIGIT )* ) ( '.' ( RULE_DIGIT )+ )? ( ( 'E' | 'e' ) ( '+' | '-' )? ( RULE_DIGIT )+ )? )
            // InternalJSON.g:1191:19: ( '-' )? ( '0' | '1' .. '9' ( RULE_DIGIT )* ) ( '.' ( RULE_DIGIT )+ )? ( ( 'E' | 'e' ) ( '+' | '-' )? ( RULE_DIGIT )+ )?
            {
            // InternalJSON.g:1191:19: ( '-' )?
            int alt1=2;
            ...
            // InternalJSON.g:1191:24: ( '0' | '1' .. '9' ( RULE_DIGIT )* )
            int alt3=2;
            ...
            switch (alt3) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // InternalJSON.g:1191:29: '1' .. '9' ( RULE_DIGIT )*
                    {
                    matchRange('1','9'); 
                    // InternalJSON.g:1191:38: ( RULE_DIGIT )*
                    loop2:
                    do {
                        int alt2=2;
            ...
            // InternalJSON.g:1191:51: ( '.' ( RULE_DIGIT )+ )?
            int alt5=2;
            ...
            switch (alt5) {
                case 1 :
                    // InternalJSON.g:1191:52: '.' ( RULE_DIGIT )+
                    {
                    match('.'); 
                    // InternalJSON.g:1191:56: ( RULE_DIGIT )+
                    int cnt4=0;
                    loop4:
                    do {
                        int alt4=2;
            ...
            // InternalJSON.g:1191:70: ( ( 'E' | 'e' ) ( '+' | '-' )? ( RULE_DIGIT )+ )?
            int alt8=2;
            ...
            switch (alt8) {
                case 1 :
                    // InternalJSON.g:1191:71: ( 'E' | 'e' ) ( '+' | '-' )? ( RULE_DIGIT )+
                    {
                    ...
                    // InternalJSON.g:1191:92: ( RULE_DIGIT )+
                    int cnt7=0;
                    loop7:
                    do {
                        int alt7=2;
    ...
    public final void mRULE_DIGIT() throws RecognitionException {
        try {
            // InternalJSON.g:1193:21: ( '0' .. '9' )
            // InternalJSON.g:1193:23: '0' .. '9'
            {
            matchRange('0','9'); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalJSON.g:1195:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalJSON.g:1195:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalJSON.g:1195:11: ( '^' )?
            int alt9=2;
            ...
            // InternalJSON.g:1195:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop10:
            do {
                int alt10=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalJSON.g:1197:10: ( ( '0' .. '9' )+ )
            // InternalJSON.g:1197:12: ( '0' .. '9' )+
            {
            // InternalJSON.g:1197:12: ( '0' .. '9' )+
            int cnt11=0;
            loop11:
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalJSON.g:1199:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalJSON.g:1199:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalJSON.g:1199:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt14=2;
            ...
            switch (alt14) {
                case 1 :
                    // InternalJSON.g:1199:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalJSON.g:1199:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop12:
                    do {
                        int alt12=3;
                    ...
                    break;
                case 2 :
                    // InternalJSON.g:1199:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalJSON.g:1199:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop13:
                    do {
                        int alt13=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalJSON.g:1201:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalJSON.g:1201:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalJSON.g:1201:24: ( options {greedy=false; } : . )*
            loop15:
            do {
                int alt15=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalJSON.g:1203:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalJSON.g:1203:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalJSON.g:1203:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop16:
            do {
                int alt16=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalJSON.g:1205:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalJSON.g:1205:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalJSON.g:1205:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt19=0;
            loop19:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalJSON.g:1207:16: ( . )
            // InternalJSON.g:1207:18: .
            {
            matchAny(); 
    ...
    static final String[] DFA20_transitionS = {
            "\11\23\2\22\2\23\1\22\22\23\1\22\1\23\1\17\4\23\1\20\4\23\1\3\1\12\1\23\1\21\1\13\11\14\1\4\6\23\32\16\1\5\1\23\1\6\1\15\1\16\1\23\5\16\1\10\7\16\1\11\5\16\1\7\6\16\1\1\1\23\1\2\uff82\23",
            "",
            "",
            "",
            "",
